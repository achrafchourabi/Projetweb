<?PHP
include "../../config.php";
include "../../Services/core/PanierCore.php";
  $pan=new PanierCore();
...
<body>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="../img/adel.jpg" class="img-circle" width="80"></a></p>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Tableau Commande</h4>
                <hr>
                <thead>
                  <tr>
                    <th><i class="fa fa-bullhorn"></i> ID_Commande</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> ID_Produit</th>
                    <th><i class="fa fa-bookmark"></i> quantitée</th>
                ...
                <tbody>
                  <tr>
                    ...
                    foreach($listePanier as $row){
                      ?>
                      <tr class="gradeX">
                     <td class="hidden-phone"><?PHP echo $row['ID_panier']; ?></td>
                      <td class="hidden-phone"><?PHP echo $row['ID']; ?></td>
                    <td class="center hidden-phone" ><?PHP echo $row['quantite']; ?></td>
                      <td class="center hidden-phone" ><?PHP echo $row['prix']; ?></td>
                       <td><select class="label label-info label-mini" >
                     <option> <span >Paid</span></option>
                         <option> <span >Not Paid</span></option>
                    </select>
                  </td>
                        
                     
                       <td> <form class="pull-right hidden-phone" method="POST" action="supprimerPanier.php">
  ...
  <input  type="hidden" value="<?PHP echo $row['ID_panier']; ?>" name="ID_panier">
                     ...
                     <input  type="hidden" value="<?PHP echo $row['ID_panier']; ?>" name="ID_panier">
  <button><a   class="btn btn-primary btn-xs" href="modifierPanier.php?ID_panier=<?PHP echo $row['ID_panier']; ?>"><i class="fa fa-pencil"></i></a>
  </button>
</class="pull-right></td>
</form>
                         <?php } ?>
