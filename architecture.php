...
<head>
<title>Architecture du site STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Site Map">
<meta name="description" content="Zen Cart! : Site Map - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=site_map">
...
ou par fax au 01 46 49 10 81 </p>             
 ...
 <span> Architecture du site</span>
</div>
                  </div>
      <div class="main-col 
...
<div class="heading"><h1>Architecture du site</h1></div>

<div id="siteMapMainContent" class="content">
<p><strong>Pour vous assisstez dans votre navigation , nous vous proposons ici l'architecture du site</strong></p>
<p>Si vous avez du mal à localiser un élément, visitez notre <a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=contact_us">page </a> contactez nous  </p>
</div>

    <div id="siteMapList">
<ul><li><a href="http://localhost/views/salledebain.php">Salle de bain</a>
<ul><li><a href="http://localhost/views/accessoiresSB.php">Accessoires salle de bain</a></li>
<li><a href="http://localhost/views/baignoire.php">Baignoires</a></li>
<li><a href="http://localhost/views/robinets.php">Robinetterie et Lavabo</a></li>
</ul>
</li>
<li><a href="http://localhost/views/MaisonetJardin.php">Maison et Jardin</a>
<ul><li><a href="http://localhost/views/tuyaux.php">Tuyaux et Echangeurs</a></li>
</ul>
</li>
<li><a href="http://localhost/views/cuisine.php">Cuisine</a>
</ul>
</li>
<li><a >Réparation</a>
<ul><li><a >Electricité</a></li>
...
<li><a >Peinture</a></li>
<li><a >Autres Equipements</a></li>
<li><a >Divers</a></li>
<li><a >Water Taps</a></li>
<li><a >Accessories</a></li>
</ul>
      
</div>
<br class="clearBoth" />
<div class="buttonRow back"><a href="http://localhost/views/mainpage1.php"><span class="cssButton normal_button button  button_back" onmouseover="this.className='cssButtonHover normal_button button  button_back button_backHover'" onmouseout="this.className='cssButton normal_button button  button_back'">&nbsp;Retour&nbsp;</span></a></div>
</div>        </div>
