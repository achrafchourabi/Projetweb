...
$listeEvaluations=$evaluation1C->moyenne();
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <li><a href="mail.php">Enovyer un mail</a></li>
...
<form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="statistiques.php">
  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="Stat" value="Stat">Statistiques</button>
                    </div>
                  </div>
</form>
            <!-- /content-panel -->
