...
<head>
<title>Salle de bain STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Bathroom">
<meta name="description" content="Zen Cart! : Bathroom - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;cPath=1">
...
<!-- BOF- BANNER TOP display -->
  ...
  <div class="messageStackSuccess larger"><span class="close_msg"></span><img src="includes/templates/theme002/images/icons/success.png"  alt="Success" title=" Success " />  Successfully added Product to the cart ...</div>
...
ou par fax au 01 46 49 10 81 </p>             
 ...
 <span> Salle de Bain</span>
   ...
   <h2 class="centerBoxHeading">Salle de bain</h2> 
<div class="content_scene_cat_bg">

      		    <div id="category-image" class="categoryImg">
              <img src="images/cat1.jpg" class="img-responsive" alt="" width="1040" height="400" />              <div class="cat_desc">
					                        <div class="catDescContent">
                            Catégorie Salle de Bain : Vous trouverez ici tous les accessoires ainsi que les éléments sanitaires de cette catégorie                       </div>
...
<div id="subcategories">
        ...
        <ul class="row">
    <li class="categoryListBoxContents col-md-3 col-sm-6 col-xs-12"><a href="http://localhost/views/accessoiresSB.php"><div data-match-height="catRow" class="subcategory-image "><img src="images/sub1.jpg" class="img-responsive" alt="Lorem" title=" Lorem " width="158" height="61" /></div><span>Accessoires salle de bain</span></a></li>    <li class="categoryListBoxContents col-md-3 col-sm-6 col-xs-12"><a href="http://localhost/views/baignoire.php"><div data-match-height="catRow" class="subcategory-image "><img src="images/sub2.jpg" class="img-responsive" alt="Ipsum" title=" Ipsum " width="158" height="61" /></div><span>Baignoires</span></a></li>   

    <li class="categoryListBoxContents col-md-3 col-sm-6 col-xs-12"><a href="http://localhost/views/robinets.php"><div data-match-height="catRow" class="subcategory-image "><img src="images/sub4.jpg" class="img-responsive" alt="Sit epsum" title=" Sit epsum " width="158" height="61" /></div><span>Robinets et Lavabo</span></a></li>
...
<h2 class="centerBoxHeading">Nouveaux produits catégorie Salle de bain ( Mars )</h2><ul class="prod-list1 clearfix w25">

    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Soupape de remplissage en plomb</a></h5>
				<div class="img">
					<a ><img src="images/05.png" class="img-responsive" alt="Plumb Craft Toilet Tank Fill Valve" title="Soupape de remplissage en plomb" width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">49.50 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn products-button add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div>
						<div class="button1" ><a  href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&cPath=1_33&products_id=5" class="btn products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>    <li class="centerBoxContentsFeatured centeredContent back  i2" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Valve de contrôle en plomb push in</a></h5>
				<div class="img">
					<a ><img src="images/06.png" class="img-responsive" alt="Plumb Pak 12-in Brass Push Fit In-Line Straight Valve" title=" Valve de contrôle en plomb push in " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">12 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn products-button add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>    <li class="centerBoxContentsFeatured centeredContent back  i3" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Evier 13 x 17 Single</a></h5>
				<div class="img">
					<a ><img src="images/07.png" class="img-responsive" alt="Schon 13 x 17 Single Bowl Zero Radius Bar Sink" title=" Evier 13 x 17 Single " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">50 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
			...
			</div></li>    <li class="centerBoxContentsFeatured centeredContent back  i4" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Outil de serrage de valve</a></h5>
				<div class="img">
					<a ><img src="images/08.png" class="img-responsive" alt="Superior Tool Soft Jaws Plumbing Pliers 06012" title="Outil de serrage de valve" width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">15 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
    ...
    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Evier pour cuisine taille S</a></h5>
				<div class="img">
					<a ><img src="images/09.png" class="img-responsive" alt="Undermount Kitchen Sink" title=" Evier pour cuisine taille S " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">75 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
				...
				<h5><a class="product-name name" >Echangeur multifonctions pour cuisine</a></h5>
				<div class="img">
					<a ><img src="images/10.png" class="img-responsive" alt="Vigo One Handle Single Hole Pull Out Spray Kitchen Faucet" title=" Echangeur multifonctions pour cuisine " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">69.50 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
...
<div class="centerBoxWrapper clearfix" id="featuredProducts">
	  ...
	  <h2 class="centerBoxHeading">Produits en vedette - Salle de bain</h2>
    ...
    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" >Pomme de douche à main 5 positions</a></h5>
        <div class="img">
          <a ><img src="images/02.png" class="img-responsive" alt="Plumb Craft 5 Position Hand Held Shower Head - 8661" title="Pomme de douche à main 5 positions" width="200" height="200" /></a>
          <div class="price">
            <strong><span class="productSalePrice">25 DT</span></strong>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="prod-info">
        ...
        </li>    <li class="centerBoxContentsFeatured centeredContent back  i2" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" >Tête de douche 6 positions plastique dur</a></h5>
        <div class="img">
          <a ><img src="images/03.png" class="img-responsive" alt="Plumb Craft 6 Spray Setting Fixed Shower Head - 8674000" title=" Tête de douche 6 positions plastique dur " width="200" height="200" /></a>
          <div class="price">
            <strong><span class="productSalePrice">20 DT</span></strong>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="prod-info">
          <div class="product-buttons">
            ...
            <div class="button1"><a class="btn products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div>
				...
				<h5><a class="product-name name" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=1_31&amp;products_id=4">Poignée de robinet en acrylique avec fossette de remplacement </a></h5>
        <div class="img">
          <a ><img src="images/04.png" class="img-responsive" alt="Plumb Craft Acrylic Handle with Skirt Faucet Replacement" title="Poignée de robinet en acrylique avec fossette de remplacement " width="200" height="200" /></a>
          <div class="price">
            <strong><span class="productSalePrice">8.00 DT</span></strong>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="prod-info">
        ...
        <div class="prod-info">
          <div class="product-buttons">
            ...
            <div class="button1"><a class="btn products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div>
				...
				<h5><a class="product-name name" href="http://localhost/views/produit1.php">Robinet style moderne Cuisine et Salle de bain</a></h5>
				<div class="img">
					<a ><img src="images/11.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain" width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSpecialPrice">71.00 DT</span><span class="normalprice">89 DT </span><span class="productPriceDiscount">-20%</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://localhost/views/produit1.php"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>    <li class="centerBoxContentsFeatured centeredContent back  i4" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" href="http://localhost/views/produit2.php" >Lavabo en céramique Bronze style carthage</a></h5>
				<div class="img">
					<a href="http://localhost/views/produit2.php"><img src="images/12.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSpecialPrice">90 DT</span><span class="normalprice">124.00 DT</span><span class="productPriceDiscount">-15%</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://localhost/views/produit2.php"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>
