            ...
            <!--  BASIC PROGRESS BARS -->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  ...
                  <tr class="gradeX">
                     <td class="hidden-phone"><?PHP echo $row['ID_plomb']; ?></td>
                      <td class="hidden-phone"><?PHP echo $row['nom_plomb']; ?></td>
                    <td class="center hidden-phone" ><?PHP echo $row['demande_plomb']; ?></td>
                      <td class="center hidden-phone" ><?PHP echo $row['lieu_plomb']; ?></td>
              
                     <td class="center hidden-phone"><?PHP echo $row['details_plomb']; ?></td>
