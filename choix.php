            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm">
                  ...
                  <div class="form-group ">
                    <label for="Idlivreur" class="control-label col-lg-2">Idlivreur</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="Idlivreur" name="Idlivreur" type="number" value="<?PHP echo $adresse?>"/>
                    </div>
                  </div>
...
if (isset($_POST['modifier'])){
	...
	$livraisonC->confirmerAffectation($livraison,$_POST['Id'],$_POST['Idlivreur']);
	echo $_POST['Id'];
