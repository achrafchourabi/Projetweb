...
<!-- eof tm custom block -->
 <div class="nav">
      ...
      <div class="heading"><h1>Merci d'avoir pris le temps pour évaluer nos livreurs !</h1></div>
      
      <div class="tie">
          <div class="tie-indent">
            <form name="ajout" id="ajoutEvaluation" action="ajoutEvaluationback.php" method="POST" onsubmit="return verifForm(this)">
      <legend>Merci de bien vouloir donner une note</legend>
      <div class="form-group">
      <label class="inputLabel" for="Note">Note:  </label>
      <input type="number" name="Note" size="33" maxlength="32" id="Note" class="form-control" onblur="verifnote(this)"></div>
       <div class="form-group">
      <label class="inputLabel" for="Idlivreur">Id du livreur:  </label>
      <input type="number" name="Idlivreur" size="33" maxlength="32" id="Idlivreur" class="form-control" onblur="verifidl(this)"></div>
         
      <div class="buttonRow"><input type="submit" class="btn btn-success add-to-cart" name="note" value="confirmer"></div>
  </form>
</div>
</div>
</div>
...
{
   var pseudoOk = verifnote(f.Note);
   var mailOk = verifidl(f.Idlivreur);
...
<!-- Google Tag Manager --><noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-P9FT69"height="0" width="

    0" style="display:none;visibility:hidden"></iframe></noscript><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-P9FT69');</script><!-- End Google Tag Manager -->
</html>
