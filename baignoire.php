...
<head>
<title>Bagnoires STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Ipsum">
<meta name="description" content="Zen Cart! : Ipsum - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;cPath=1_32">
...
zcJS.ajax = function (options) {
  ...
  var deferred = $.Deferred(function (d) {
      var securityToken = 'a33d86c9545ec564551168d6b57f3cce';
      var defaults = {
          cache: false,
          type: 'POST',
          traditional: true,
...
ou par fax au 01 46 49 10 81 </p>             
  ...
  <a href="http://localhost/views/salledebain.php">Salle de bain</a>
...
<h2 class="centerBoxHeading">Baignoires</h2>
<div class="content_scene_cat_bg">

          <div id="category-image" class="indexCategories">
            <img src="images/sub1.jpg" class="img-responsive" alt="" width="1040" height="400" />            <div class="cat_desc">
                                <div class="catDescContent">
                          Catégorie baignoires : Vous retrouverez ici toutes les baignoires exposées dans notre boutique                     </div>
...
<form role="form" name="filter" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index" method="get"><label class="inputLabel">Filtrer par : </label><input type="hidden" name="main_page" value="index" />

<input type="hidden" name="cPath" value="1_31" /><input type="hidden" name="sort" value="20a" />
        ...
        <div class="dropdown">
          ...
          <li><a href="javascript:void(0);" onclick="document.getElementById('filter_id').value= '3';document.filter.submit();">Bosch</a></li><li><a href="javascript:void(0);" onclick="document.getElementById('filter_id').value= '1';document.filter.submit();">Gerber</a></li><li><a href="javascript:void(0);" onclick="document.getElementById('filter_id').value= '2';document.filter.submit();">Viessmann</a></li>
          </ul>
        </div>
      <select name="alpha_filter_id" onchange="this.form.submit()">
  <option value="0">Accessoires commençant par la lettre ...</option>
