...
$listeLivraisons=$livraison1C->rechercheAvancee($_POST['champ']);
  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <li><a href="statistique.php">Statistique des évaluatons pour les evaluations</a></li>
              <li><a href="stat.php">Statistique des évaluatons pour les livraisons</a></li>
            </ul>
          </li>
          <li>
              <a href="index.html">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Recherche livraison</h3>
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Recherche livraison</h4>
                <hr>
                <thead>
                  <tr>
                    <td>Id</td>
...
<form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="rechercherLivraison.php" onsubmit="return verifForm(this)">
  <div class="form-group ">
                    <label for="champ" class="control-label col-lg-2">Champ a rechercher</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="champ" name="champ" type="text" onblur="verifcham(this)"/>
                    </div>
                  </div>
...
{
   var pseudoOk = verifcham(f.Champ);
