...
<div id="productMainImage" class="pull-left image-block">
  ...
  <img src="../images/clim.jpg" class="img-responsive" alt="entretien et réparation des chauffage et climatiseurs" title="entretien et réparation des chauffage et climatiseurs " width="200" height="200" />  <span class="zoom"></span></a></span>
    ...
    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="#""><img src="..images/elect1.jpg" class="img-responsive" alt="notre service éléctricitée" title="notre service éléctricitée est basée sur l'installation,la réparation et meme l'entretien de vos matériaux " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="#"><img src="../images/elect2.jpg" class="img-responsive" alt="notre service éléctricitée" title="notre service éléctricitée est basée sur l'installation,la réparation et meme l'entretien de vos matériaux " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="#" ><img src="../images/elect3.jpg"class="img-responsive" alt="notre service éléctricitée" title="notre service éléctricitée est basée sur l'installation,la réparation et meme l'entretien de vos matériaux " width="114" height="114" /></a></li>
   ...
   <div class="video_desc">
            ...
            <!--bof  -->
                ...
                <iframe src="https://www.youtube.com/watch?v=66rf82PJuls" allowfullscreen></iframe></div>
            <!--eof YouTube -->
 ...
 <li><strong>responsable </strong>Ali</li>
            ...
            <div class="wrapper atrib2"> 
              <!--bof Attributes Module -->
                <form  name="FormulaireElectricity" method="POST" action="../views/addElect.php" />
                                            <div id="productAttributes">

<div class="wrapperAttribsOptions">
<h4 class="optionName back">Nom de votre Société</h4>
<input type="text" name="nom_elect" value="">
</div>

<div class="wrapperAttribsOptions">
<h4 class="optionName back"><label class="attribsSelect" for="attrib-2">Lieu</label></h4>

<select name="lieu_elect"class="form-control">
  <option name="lieu_elect">Select from below ...</option>
  <option name="lieu_elect">Grand Tunis</option>
  <option name="lieu_elect">autre</option>
</select>
...
<select name="demande_elect" class="form-control">
      <option  value="37">Select from below ...</option>
  <option name="demande_elect" value="Installation">Installation</option>
  <option name="demande_elect" value="Panne">Panne</option>
  <option name="demande_elect" value="autre">autre</option>
</select>


<h4 class="optionName back" Plus de détails à propos votre demande:></h4>

<textarea name="details_elect"row="4" cols="40" >Plus de détails à propos votre demande</textarea>
            ...
            <div id="button_product">
                <div class="add_to_cart_row">
                  <strong class="fleft text2">
                    <input type="text" class="form-control" name="cart_quantity" value="1" maxlength="6" size="8" /><input type="hidden" name="products_id" value="12" /></strong><span class="buttonRow">
