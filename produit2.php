...
<head>
<title>LAVABO EN CÉRAMIQUE BRONZE STYLE CARTHAGE</title>
<meta charset="utf-8">
<meta name="keywords" content="Vigo Tempered Glass Bathroom Sink - VG07505 [Model3] Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
<meta name="description" content="Zen Cart! Vigo Tempered Glass Bathroom Sink - VG07505 [Model3] - The supplies we sell in our store are of premium quality and will serve you for years. We enrich our Plumbing Supplies Store only with the well tested models which have won trust and are known thanks to their resistance to depreciation. Modern and reliable they will cause you no ">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;products_id=12">
...
zcJS.ajax = function (options) {
  ...
  var deferred = $.Deferred(function (d) {
      var securityToken = 'a9c803e7acb2e2a793f102deb2851196';
      var defaults = {
          cache: false,
          type: 'POST',
          traditional: true,
...
ou par fax au 01 46 49 10 81 </p>             
 ...
 <span> Lavabo en céramique Bronze style carthage</span>
</div>
                  </div>
      <div class="main-col 
...
<div class="centerColumn" id="productGeneral">
  ...
  <div class="tie">
    <div class="tie-indent">
      ...
      <!--bof Form start--> 
        <form role="form" name="cart_quantity" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=12&amp;number_of_uploads=0&amp;action=add_product" method="post" enctype="multipart/form-data"><input type="hidden" name="securityToken" value="a9c803e7acb2e2a793f102deb2851196" />
...
<div id="productMainImage" class="pull-left image-block">
	<span class="image"><a href="images/12.png">
	<img src="images/12.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="200" height="200" />	<span class="zoom"></span></a></span>
    ...
    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/12-1.png"><img src="images/12-1.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/12-2.png"><img src="images/12-2.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/12-3.png"><img src="images/12-3.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="114" height="114" /></a></li>

    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/12-4.png"><img src="images/12-4.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/12-5.png"><img src="images/12-5.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="114" height="114" /></a></li>
          ...
          <div class="video_desc">
            ...
            <!--bof  -->
                ...
                <iframe src="https://www.youtube.com/embed/IM1bWY-oWlw" allowfullscreen></iframe></div>
            <!--eof YouTube -->
            <!--bof Product description -->
                        <div id="productDescription" class="description biggerText col-sm-12 col-xs-12 col-sm-12 ">Ici une vidéo pour vous aider à monter votre lavabo</div>
          ...
          <div class="pb-center-column col-xs-12 col-sm-6"> 
            <!--bof free ship icon  -->
                        <!--eof free ship icon  -->
            <h2 class="title_product">Lavabo en céramique Bronze style carthage</h2>
            <h3 class="sub_title">Description</h3>
            <!--bof Product description -->
                        <div id="shortDescription" class="description">Un modèle de lavabo assez original , il reprend les anciens modèles de l'antique carthage , fait en céramique avec une couche de bronze , ce lavabo donnera un air d'antan à votre salle de bain</div>
                        <!--eof Product description -->
            <!--bof Product details list  -->
			            <ul class="instock">
              <li><strong>Poids: </strong>8kg</li>
 <li><strong>Equipementiers: </strong>Bosch</li>
            </ul>
                        <!--eof Product details list  --> 
            <div class="wrapper atrib"> <span class="quantity_label">1000 unités en stock</span>
              <!--bof Reviews button and count-->
                            <div id="productReviewLink" class="buttonRow left"><a class="btn-default-small" ><span class="cssButton normal_button button  button_reviews" onmouseover="this.className='cssButtonHover normal_button button  button_reviews button_reviewsHover'" onmouseout="this.className='cssButton normal_button button  button_reviews'">&nbsp;Go to the Reviews Page&nbsp;</span></a></div>
              <br class="clearBoth">
              <p class="reviewCount">Current Reviews: 0</p>
...
<select name="id[2]" id="attrib-2" class="form-control">
  <option value="37">Séléctionnez</option>
...
<div class="wrapperAttribsOptions">
<h4 class="optionName back">Livraison</h4>

Livraison gratuite inclue ! <br />
</div>
...
<div class="wrapperAttribsOptions">
<h4 class="optionName back">Bronze</h4>

<span class="option two"><input type="checkbox" name="id[16][55]" value="55" id="attrib-16-55" /><label class="attribsCheckbox" for="attrib-16-55">Bronze 5</label></span>
<span class="option two"><input type="checkbox" name="id[16][56]" value="56" id="attrib-16-56" /><label class="attribsCheckbox" for="attrib-16-56">Bronze 6</label></span>
<span class="option two"><input type="checkbox" name="id[16][59]" value="59" id="attrib-16-59" /><label class="attribsCheckbox" for="attrib-16-59">Bronze 7</label></span>
<span class="option two"><input type="checkbox" name="id[16][60]" value="60" id="attrib-16-60" /><label class="attribsCheckbox" for="attrib-16-60">Bronze 8</label></span>
            ...
            <div class="add_to_cart_block"> 
              <!--bof Add to Cart Box -->
                                                        <div id="prod-price">
                &nbsp;<span class="productSpecialPrice">90 DT</span><span class="normalprice">124.00 DT </span><span class="productPriceDiscount">-15%</span>              </div>
              <div class="clearfix"></div>
            ...
            <div id="button_product">
                <div class="add_to_cart_row"><strong class="fleft text2"><input type="text" class="form-control" name="cart_quantity" value="1" maxlength="6" size="8" /><input type="hidden" name="products_id" value="12" /></strong><span class="buttonRow"><input type="submit" class="btn btn-success add-to-cart" value="Ajouter au panier" /></span></div>              </div>
        ...
        <div class="text2">
          ...
          <!--bof Product date added/available-->
                    <p id="productDateAdded" class="productGeneral centeredContent">Produit Ajouté le 20/03/2019</p>
...
<h2 class="centerBoxHeading">Les clients qui ont acheté ce produit ont aussi vu ...</h2>
    <div class="centerBoxContentsAlsoPurch" style="width:33%;">
	  
	  			<div class="product-col" >
					   <div class="img">
               <a ><img src="http://localhost/views/lavabo1.jpg" class="img-responsive" alt="Vigo Two Handle Widespread Pull-Out Spray Bar Faucet with Soap D" title=" Vigo Two Handle Widespread Pull-Out Spray Bar Faucet with Soap D " width="114" height="114" /></a></div><div class="prod-info"><a class="product-name name" >Lavabo moderne tactile/détecteur de </a></div></div></div>
