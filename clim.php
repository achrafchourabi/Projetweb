...
<textarea name="details"  value="details" row="4" cols="40" id= "details">Details</textarea>
     ...
     <form name="ID_panier" method="POST" action="views/addPanier.php">                                     <!--eof Attributes Module --> 
              
            <div class="add_to_cart_block"> 
              <!--bof Add to Cart Box -->
                                <div id="prod-price">
                <input type="text" name="prix" class="productSpecialPrice" value="522,40">$522.40</input>
                <span class="normalprice">$653.00 </span>
                <span class="productPriceDiscount">-20%</span>              
            </div>                       
            ...
            <div id="button_product">
                <div class="add_to_cart_row">
                  <strong class="fleft text2">
                    <input type="text" class="form-control" name="quantite" maxlength="6" size="8" /><input type="hidden" name="products_id" value="12" /></strong><span class="buttonRow">
