...
<head>
<title>Robinet style moderne Cuisine et Salle de bain STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300 [Model2] Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
<meta name="description" content="Zen Cart! Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300 [Model2] - The supplies we sell in our store are of premium quality and will serve you for years. We enrich our Plumbing Supplies Store only with the well tested models which have won trust and are known thanks to their resistance to depreciation. Modern and reliable they will cause you no ">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;products_id=11">
...
ou par fax au 01 46 49 10 81 </p>             
 ...
 <span> Robinet style moderne Cuisine et Salle de bain</span>
</div>
                  </div>
      <div class="main-col 
...
<div class="centerColumn" id="productGeneral">
  ...
  <div class="tie">
    <div class="tie-indent">
      ...
      <!--bof Form start--> 
        <form role="form" name="cart_quantity" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=11&amp;number_of_uploads=0&amp;action=add_product" method="post" enctype="multipart/form-data"><input type="hidden" name="securityToken" value="58a89b6ee53d1667faaf891bf88c992f" />
...
<div id="productMainImage" class="pull-left image-block">
	<span class="image"><a href="images/11.png">
	<img src="images/11.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain " width="200" height="200" />	<span class="zoom"></span></a></span>
    ...
    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/11-1.png"><img src="images/11-1.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/11-2.png"><img src="images/11-2.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/11-3.png"><img src="images/11-3.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain " width="114" height="114" /></a></li>

    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/11-4.png"><img src="images/11-4.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain " width="114" height="114" /></a></li>    <li class="additionalImages centeredContent back" style="width:20%;">
      <a href="images/11-5.png"><img src="images/11-5.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Robinet style moderne Cuisine et Salle de bain " width="114" height="114" /></a></li>
          ...
          <div class="video_desc">
            ...
            <!--bof  -->
                ...
                <iframe src="http://www.youtube-nocookie.com/embed/mZ5Gw7rhYkc?rel=0&amp;showinfo=0&amp;fs=0" allowfullscreen></iframe></div>
            <!--eof YouTube -->
            <!--bof Product description -->
                        <div id="productDescription" class="description biggerText col-sm-12 col-xs-12 col-sm-12 ">Ici une vidéo pour vous aider à faire un choix judicieux pour vos robinets</div>
          ...
          <div class="pb-center-column col-xs-12 col-sm-6"> 
            <!--bof free ship icon  -->
                        <!--eof free ship icon  -->
            <h2 class="title_product">Robinet style moderne Cuisine et Salle de bain</h2>
            <h3 class="sub_title">Description </h3>
            <!--bof Product description -->
                        <div id="shortDescription" class="description">Nous vous proposons ici un modèle moderne et stylé de robinet qui donne un air très intelligent à votre salle de bain , vous aurez le choix entre plusieurs coloris le tout à un prix intéressant </div>
                        <!--eof Product description -->
            <!--bof Product details list  -->
			            <ul class="instock">
              <li><strong>Poids: </strong>200g</li>
 <li><strong>Equipementier: </strong>Viessmann</li>
            </ul>
                        <!--eof Product details list  --> 
            <div class="wrapper atrib"> <span class="quantity_label">1000 Unités en stock</span>
              <!--bof Reviews button and count-->
                            <div id="productReviewLink" class="buttonRow left"><a class="btn-default-small" href="http://localhost/views/pageevaluation.php"><span class="cssButton normal_button button  button_reviews" onmouseover="this.className='cssButtonHover normal_button button  button_reviews button_reviewsHover'" onmouseout="this.className='cssButton normal_button button  button_reviews'">&nbsp;Aller à la page Evaluation de cet article&nbsp;</span></a></div>
              <br class="clearBoth">
...
<h4 class="optionName back">Couleur</h4>

<span class="option"><input type="radio" name="id[1]" value="25" id="attrib-1-25" /><label class="attribsRadioButton zero" for="attrib-1-25">Orange</label></span>
<span class="option"><input type="radio" name="id[1]" value="26" id="attrib-1-26" /><label class="attribsRadioButton zero" for="attrib-1-26">Vert</label></span>
<span class="option"><input type="radio" name="id[1]" value="15" id="attrib-1-15" /><label class="attribsRadioButton zero" for="attrib-1-15">Bleu</label></span>
<span class="option"><input type="radio" name="id[1]" value="28" id="attrib-1-28" /><label class="attribsRadioButton zero" for="attrib-1-28">Violet</label></span>
<span class="option"><input type="radio" name="id[1]" value="29" id="attrib-1-29" /><label class="attribsRadioButton zero" for="attrib-1-29">Noir</label></span>
<span class="option"><input type="radio" name="id[1]" value="32" id="attrib-1-32" /><label class="attribsRadioButton zero" for="attrib-1-32">Or</label></span>
...
<select name="id[2]" id="attrib-2" class="form-control">
  <option value="37">Choisir ...</option>
  <option value="21">Petit</option>
  ...
  <option value="20">Grand</option>
            ...
            <div class="add_to_cart_block"> 
              <!--bof Add to Cart Box -->
                                                        <div id="prod-price">
                &nbsp;<span class="productSpecialPrice">71.00 DT</span><span class="normalprice">89 DT </span><span class="productPriceDiscount">-20%</span>              </div>
              <div class="clearfix"></div>
            ...
            <div id="button_product">
                <div class="add_to_cart_row"><strong class="fleft text2"><input type="text" class="form-control" name="cart_quantity" value="1" maxlength="6" size="8" /><input type="hidden" name="products_id" value="11" /></strong><span class="buttonRow"><input type="submit" class="btn btn-success add-to-cart" value="Ajouter au panier" /></span></div>              </div>
        ...
        <!--bof also related products module-->
            ...
            <h2 class="centerBoxHeading clearfix">Produits reliés</h2>            <div class="row">
			
    <div class="col-xs-12 col-sm-4 col-md-2"><div data-match-height="items-e" class="product-col"><div class="img"><a ><img src="images/10.png" class="img-responsive" alt="Superior Tool Soft Jaws Plumbing Pliers 06012" title=" Echangeur multifonctions pour cuisine " width="114" height="114" /></a></div><div class="prod-info"><a class="product-name name" >Echangeur multifonctions pour cuisine</a></div></div></div>
    
    
<br class="clearBoth" />

    <div class="col-xs-12 col-sm-4 col-md-2"><div data-match-height="items-e" class="product-col"><div class="img"><a ><img src="images/18.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Robinet de collection whitehaus" width="114" height="114" /></a></div><div class="prod-info"><a class="product-name name" >Robinet de collection whitehaus</a></div></div></div>
    <div class="col-xs-12 col-sm-4 col-md-2"><div data-match-height="items-e" class="product-col"><div class="img"><a ><img src="images/19.png" class="img-responsive" alt="Vigo Two Handle Widespread Pull-Out Spray Bar Faucet with Soap D" title=" Echangeur Chaud/Froid cuisine " width="114" height="114" /></a></div><div class="prod-info"><a class="product-name name" >Echangeur Chaud/Froid cuisine</a></div></div></div>
<br class="clearBoth" />
        ...
        <br />
        <div class="text2">
          <p class="reviewCount"><strong>Nombre d'évaluation: 1</strong></p>
