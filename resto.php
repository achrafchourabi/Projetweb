...
<div id="productMainImage" class="pull-left image-block">
 ...
 <li><strong>Technicien responsable: </strong>mohamed</li>
        ...
        <form  name="FormulaireResto" method="POST" action="../views/addResto.php" />
 
                                            <div id="productAttributes">

<div class="wrapperAttribsOptions">
<h4 class="optionName back">Nom de votre Société</h4>
<input type="text" name="nom_resto" value="">
</div>
<h4 class="optionName back"><label class="attribsSelect" for="attrib-17">Lieu</label></h4>

<select name="lieu_resto"   class="form-control">
  <option name="lieu_resto"value="Tunis">Grand Tunis</option>
  <option name="lieu_resto"value="Autre">Autre</option>
</select>
...
<select name="demande_resto" class="form-control">
      <option  value="37">Select from below ...</option>
  <option name="demande_resto" value="Installation">Installation</option>
   <option name="demande_resto" value="Entretien">Entretien</option>
  <option name="demande_reto" value="Panne">Panne</option>
  <option name="demande_resto" value="autre">autre</option>
</select>
</div>
<div class="wrapperAttribsOptions">
<h4 class="optionName back">Secteur</h4>
<select name="secteur_resto" class="form-control">
      <option  value="37">Select from below ...</option>
  <option name="secteur_resto" value="Cuisine">Cuisine</option>
   <option name="secteur_resto" value="Haute">Haute</option>
  <option name="secteur_resto" value="Four">Four</option>
   <option name="secteur_resto" value="materiels">materiels</option>
  <option name="secteur_resto" value="autre">autre</option>
</select>
</div> 
<div class="wrapperAttribsOptions">
...
<textarea name="details_resto" row="4" cols="40" >Détails..</textarea>
