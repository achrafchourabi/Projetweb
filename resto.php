...
$ClimR=new ServCore();
$listeClima=$ClimR->afficherRestaurant();
?>
...
jQuery(window).load(function() {
 ...
 <span>Service Restauration</span>
</div>
                  </div>
      <div class="main-col 
...
<div id="productMainImage" class="pull-left image-block">
  ...
  <img src="../../images/resto.jpg" class="img-responsive"  width="200" height="200" />  <span class="zoom"></span></a></span>
   ...
   <div class="video_desc">
          ...
          <div class="pb-center-column col-xs-12 col-sm-6"> 
            <!--bof free ship icon  -->
                        <!--eof free ship icon  -->
            <h2 class="title_product">Notre service Restauration</h2>
           
            <!--bof Product description -->
                        <div id="shortDescription" class="description">Nous sommes à votre disposition pour toute installation,répéaration et meme entretien.</div>
                        <!--eof Product description -->
            ...
            <form  name="FormulaireResto" method="POST" action="addResto.php" onsubmit="return verifForm(this)">
...
<select name="demande" class="form-control">
  ...
  <option name="demande" value="Installation">Installation</option>
   <option name="demande" value="Entretien">Entretien</option>
...
<select name="secteur" class="form-control">
      <option  value="37">Select from below ...</option>
  <option name="secteur" value="Cuisine">Cuisine</option>
   <option name="secteur" value="Haute">Haute</option>
  <option name="secteur" value="Four">Four</option>
   <option name="secteur" value="materiels">materiels</option>
...
<input type="hidden" name="type" value="restauration">
             ...
             <div class="add_to_cart_block"> 
              <!--bof Add to Cart Box -->
                ...
                <input type="text" class="form-control" name="prix" value="400.40" readonly=""></input>
