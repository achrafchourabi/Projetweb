                ...
                <thead>
                  <tr>
                    ...
                    <th nom="details" class="hidden-phone">details</th>
                      ...
                      <th nom="details" class="hidden-phone"><span class="badge bg-warning">Techniciens</span></th>
                   ...
                   <?PHP
                    ...
                    <td class="center hidden-phone"><?PHP echo $row['secteur']; ?></td>
                     <td class="center hidden-phone"><?PHP echo $row['details']; ?></td>
                                          ...
                                          <td>
                     <form class="pull-right hidden-phone" method="POST" action="validerResto.php">
...
<td><button class="btn btn-success btn-xs"><i class=" fa fa-check"></i></button>  </td></form>
                        <td> <form class="pull-right hidden-phone" method="POST" action="supprimerResto.php">
