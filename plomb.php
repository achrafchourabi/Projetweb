...
$ClimR=new ServCore();
$listeClima=$ClimR->afficherPlomb();
?>
...
<div id="productMainImage" class="pull-left image-block">
  ...
  <img src="../../images/plomb.jpg" class="img-responsive" alt="entretien et réparation des chauffage et climatiseurs" title="entretien et réparation des chauffage et climatiseurs " width="200" height="200" > 
</div>                      
          ...
          <div class="pb-center-column col-xs-12 col-sm-6"> 
            ...
            <h2 class="title_product">Notre Service Plomberie</h2>
       
           
                        <div id="shortDescription" class="description">Vous rechercher un plombier compétent pour la réalisation ou la réparation de vos installations de plomberie?
Notre équipe composée d’artisans plombiers intervient chez vous pour résoudre vos besoins de plomberie. 
Appelez nous pour:

Une salle de bain à réaliser
La pose et le raccordement d’éléments sanitaires
Le remplacement de robinetterie
Un ballon d’eau chaude qui dysfonctionne
Un débouchage de wc ou d’un évier
Un dégorgement à réaliser
Des Travaux d’assainissement
Le Changement de vos mélangeur, mitigeur, robinet thermostatique, réducteur de pression, groupe de sécurité…
La réparation de vos étanchéités
La modification ou le remplacement de toutes vos canalisations d’eaux usées ou eaux-vannes en fonte ou PVC
La réparation de votre chauffe-eau
etc...</div>
                        
                  <ul class="instock">
              <li><strong>Horraire</strong>24h</li>
...
<div class="wrapperAttribsOptions">
    <form  name="FormulairePlomberie" method="POST" action="addPlomb.php"  onsubmit="return verifForm(this)">
...
<input type="hidden" name="secteur" value="plomberie">
<input type="hidden" name="type" value="plomberie">
...
<textarea name="details"  row="4" cols="40"  onblur="verifdet(this)" ></textarea>
             ...
             <div class="add_to_cart_block"> 
              <!--bof Add to Cart Box -->
                ...
                <input type="text" class="form-control" name="prix" value="2.40" readonly=""></input>
