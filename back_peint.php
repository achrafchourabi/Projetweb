                ...
                <thead>
                  <tr>
                   ...
                   <?PHP
                    ...
                    foreach($listePeint as $row){
                      ?>
                      <tr class="gradeX">
                     <td class="hidden-phone"><?PHP echo $row['ID_peint']; ?></td>
                      <td class="hidden-phone"><?PHP echo $row['nom_peint']; ?></td>
                    <td class="center hidden-phone" ><?PHP echo $row['demande_peint']; ?></td>
                      <td class="center hidden-phone" ><?PHP echo $row['lieu_peint']; ?></td>
                 
                     <td class="center hidden-phone"><?PHP echo $row['details_peint']; ?></td>
