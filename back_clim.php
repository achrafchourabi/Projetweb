...
$tech=new technicienCore();
$listeTech=$tech->afficherTechniciens();
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                   ...
                   <th class="center hidden-phone"><span class="badge bg-warning">etat</span></th>
                   ...
                   <?PHP
                    ...
                    <td class="center hidden-phone"><?PHP echo $row['secteur']; ?></td>
                     <td class="center hidden-phone"><?PHP echo $row['details']; ?></td>
                      <td>
                     <form class="pull-right hidden-phone" method="POST" action="validerClim.php">
...
$sql="SElECT Distinct e.nom,e.prenom  From Technicien e inner join service a on e.lieu= a.lieu ";
...
$result=$db->query($sql);
  ...
  ?>
   ...
   <option  name="nomTech" value="<?PHP echo $ligne['nom'].'-'.$ligne['prenom']; ?> "><?PHP echo $ligne['nom'].'-'.$ligne['prenom']; ?> 
  </option>
  <?PHP }  ?>
                         ...
                         <td> <form class="pull-right hidden-phone" method="POST" action="supprimerClim.php">
