...
<head>
<title>Maison et Jardin STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Home & Garden">
<meta name="description" content="Zen Cart! : Home & Garden - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;cPath=2">
...
ou par fax au 01 46 49 10 81 </p>             
 ...
 <span> Maison et Jardin</span>
   ...
   <h2 class="centerBoxHeading">Maison et Jardin</h2> 
<div class="content_scene_cat_bg">

      		    <div id="category-image" class="categoryImg">
              <img src="http://localhost/views/m&j.jpg" class="img-responsive" alt="" width="1040" height="400" />              <div class="cat_desc">
					                        <div class="catDescContent">
                            Catégorie Maison et Jardin : Vous trouverez ici tous les accessoires ainsi que les éléments de cette catégorie                         </div>
...
<div id="subcategories">
        ...
        <ul class="row">
        <li class="categoryListBoxContents col-md-3 col-sm-6 col-xs-12"><a href="http://localhost/views/tuyaux.php"><div data-match-height="catRow" class="subcategory-image "><img src="images/sub6.jpg" class="img-responsive" alt="Vivamus" title=" Vivamus " width="158" height="61" /></div><span>Tuyaux et Echangeurs</span></a></li>    
...
<h2 class="centerBoxHeading">Nouveaux produits catégorie Maison et Jardin ( Mars )</h2><ul class="prod-list1 clearfix w25">
    ...
    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				...
				<div class="img">
					...
					<div class="price">
						<strong><span class="productSpecialPrice">45.50 DT</span><span class="normalprice">70 DT  </span><span class="productPriceDiscount">-25%</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
...
<div class="centerBoxWrapper clearfix" id="featuredProducts">
	  ...
	  <h2 class="centerBoxHeading">Produits en vedette - Maison et Jardin</h2>
