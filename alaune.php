...
<head>
<title>Produits à la une STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Specials">
<meta name="description" content="Zen Cart! : Specials - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=specials">
...
zcJS.ajax = function (options) {
  ...
  var deferred = $.Deferred(function (d) {
      var securityToken = '3533a7ab9dffbbedcc8f0124fb5ee6ae';
      var defaults = {
          cache: false,
          type: 'POST',
          traditional: true,
...
<h2 class="centerBoxHeading">A la une</h2>

<div class="top-pg">
    <div id="productsListingTopNumber" class="navSplitPagesResult back">Affichage <strong>1</strong> à <strong>6</strong> (à <strong>6</strong> produits)</div>
...
<ul class="product_list row grid">
    ...
    <li class="item col-xs-12 col-sm-6 col-products"><div class="product-col" >
				<div class="img">
				...
				<div class="prod-info">
					...
					<div class="text">
						...
						<div class="content_price">
							<span class="price product-price"><span class="productSpecialPrice">71.00 DT</span><span class="normalprice">89 DT </span><span class="productPriceDiscount">-20%</span></span><div class="clearfix"></div><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">Ajouter au panier</span></a><a class="btn btn-success btn-sm products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">Détails</span></a>
						</div>
						<div class="clearfix"></div>
						<div class="product-buttons">
							<div class="button"><a class="btn more_info_product" >More</a></div>
							<div class="button1"><a class="btn btn-success btn-sm add-to-cart-button" href="http://localhost/views/produit1.php"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div>
						</div>
				</div>
			</div></li>    <li class="item col-xs-12 col-sm-6 col-products"><div class="product-col" >
				<div class="img">
				...
				<div class="prod-info">
					...
					<div class="text">
						...
						<div class="content_price">
							<span class="price product-price"><span class="productSpecialPrice">90 DT</span><span class="normalprice">124.00 DT </span><span class="productPriceDiscount">-15%</span></span><div class="clearfix"></div><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">Ajouter au panier</span></a><a class="btn btn-success btn-sm products-button" href="http://localhost/views/produit2.php"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">Détails</span></a>
						</div>
						<div class="clearfix"></div>
						<div class="product-buttons">
							<div class="button"><a class="btn more_info_product" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=12">More</a></div>
				...
				<div class="img">
					<a ><img src="images/13.png" class="img-responsive" alt="Vigo Two Handle Widespread Pull-Out Spray Bar Faucet with Soap D" title=" Echangeur double fonction Cuisine et Jardin " width="200" height="200" /></a>
				</div>
				<div class="prod-info">
					<h5><a class="product-name name" >Echangeur double fonction Cuisine et Jardin</a></h5>
					...
					<div class="text">
						...
						<div class="content_price">
							<span class="price product-price"><span class="productSpecialPrice">105 DT</span><span class="normalprice">122.5 DT </span><span class="productPriceDiscount">-15%</span></span><div class="clearfix"></div><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">Ajouter au panier</span></a><a class="btn btn-success btn-sm products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">Détails</span></a>
						</div>
						<div class="clearfix"></div>
						<div class="product-buttons">
							<div class="button"><a class="btn more_info_product" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=4&amp;products_id=13">More</a></div>
							<div class="button1"><a class="btn btn-success btn-sm add-to-cart-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=&amp;products_id=16"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
						</div>
				</div>
			</div></li>    <li class="item col-xs-12 col-sm-6 col-products"><div class="product-col" >
				<div class="img">
					<a ><img src="images/14.png" class="img-responsive" alt="Waterstone Traditional Deck Mount One Handle Single Hole Pot Fil" title=" Echangeur traditionnel en Inox à une poignée" width="200" height="200" /></a>
				</div>
				<div class="prod-info">
					<h5><a class="product-name name" >Echangeur traditionnel en Inox à une poignée</a></h5>
					...
					<div class="text">
						...
						<div class="content_price">
							<span class="price product-price"><span class="productSpecialPrice">45.50 DT</span><span class="normalprice">70 DT </span><span class="productPriceDiscount">-25%</span></span><div class="clearfix"></div><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">Ajouter au panier</span></a><a class="btn btn-success btn-sm products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">Détails</span></a>
						</div>
						<div class="clearfix"></div>
						<div class="product-buttons">
							<div class="button"><a class="btn more_info_product" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=4&amp;products_id=14">More</a></div>
							<div class="button1"><a class="btn btn-success btn-sm add-to-cart-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=&amp;products_id=16"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
						</div>
				</div>
			</div></li>
    ...
    <li class="item col-xs-12 col-sm-6 col-products"><div class="product-col" >
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=&amp;products_id=15"><img src="images/15.png" class="img-responsive" alt="Watts 1-in x 1-ft Reinforced PVC Reinforced Braided Vinyl Tubing" title=" Tuyau Jardin 70 mètres Résistant " width="200" height="200" /></a>
				</div>
				<div class="prod-info">
					<h5><a class="product-name name" href="http://localhost/views/produit3.php">Tuyau Jardin 70 mètres Résistant</a></h5>
					...
					<div class="text">
						...
						<div class="content_price">
							<span class="price product-price"><span class="productSpecialPrice">19.99 DT</span><span class="normalprice">30 DT </span><span class="productPriceDiscount">-30%</span></span><div class="clearfix"></div><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">Ajouter au panier</span></a><a class="btn btn-success btn-sm products-button" href="http://localhost/views/produit3.php"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">Details</span></a>
						</div>
						<div class="clearfix"></div>
						<div class="product-buttons">
							<div class="button"><a class="btn more_info_product" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=4&amp;products_id=15">More</a></div>
							<div class="button1"><a class="btn btn-success btn-sm add-to-cart-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=&amp;products_id=16"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
						</div>
				</div>
			</div></li>    <li class="item col-xs-12 col-sm-6 col-products"><div class="product-col" >
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=&amp;products_id=16"><img src="images/16.png" class="img-responsive" alt="Whirlpool 40 Gallons 6-Year Regular Electric Water Heater" title=" Chauffe-eau électrique 40W en inox" width="200" height="200" /></a>
				</div>
				<div class="prod-info">
					<h5><a class="product-name name" >Chauffe-eau électrique 40W en inox</a></h5>
					...
					<div class="text">
						...
						<div class="content_price">
							<span class="price product-price"><span class="productSpecialPrice">199 DT</span><span class="normalprice">250 DT </span><span class="productPriceDiscount">-50%</span></span><div class="clearfix"></div><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">Ajouter au panier</span></a><a class="btn btn-success btn-sm products-button" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">Détails</span></a>
						</div>
						<div class="clearfix"></div>
						<div class="product-buttons">
							<div class="button"><a class="btn more_info_product" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=4&amp;products_id=16">More</a></div>
							<div class="button1"><a class="btn btn-success btn-sm add-to-cart-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=&amp;products_id=16"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
						</div>
				</div>
			</div></li>
...
<div class="bottom-pg">
<div id="specialsListingBottomNumber" class="navSplitPagesResult back">Affichage <strong>1</strong> à <strong>6</strong> (à <strong>6</strong> produits)</div>
<div class="bottom-paginator">
    <ul id="specialsListingBottomLinks" class="pagination"> &nbsp;</ul>
</div>
