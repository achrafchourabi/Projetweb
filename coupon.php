...
<head>
<title>Coupons STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Discount Coupon">
<meta name="description" content="Zen Cart! : Discount Coupon - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=discount_coupon">
...
<div class="heading"><h1>Codes Promo</h1></div>

<div id="discountcouponInfoMainContent" class="content">
<p><strong>Section coupon Discount.</strong></p>
<p>Si vous possédez un code promo ou un coupon Discount</p>
<p>Vous pouvez l'introduire ici pour bénéficier de la promotion</p></div>

<form role="form" name="discount_coupon" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=discount_coupon&amp;action=lookup" method="post"><input type="hidden" name="securityToken" value="3533a7ab9dffbbedcc8f0124fb5ee6ae" /><fieldset>
<legend>Codes Promo </legend>
</fieldset>
<div class="form-group">
    <label class="inputLabel" for="lookup-discount-coupon">Votre Code: </label>
    <input type="text" name="lookup_discount_coupon" size="40" id="lookup-discount-coupon" class="form-control" /></div>
<br>
...
<a href="http://localhost/views/mainpage1.php"><span class="cssButton normal_button button  button_back" onmouseover="this.className='cssButtonHover normal_button button  button_back button_backHover'" onmouseout="this.className='cssButton normal_button button  button_back'">&nbsp;Retour&nbsp;</span></a></div>
<br class="clearBoth" />
</form>
