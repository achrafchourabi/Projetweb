...
<head>
<title>Panier STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store The Shopping Cart">
<meta name="description" content="Zen Cart! : The Shopping Cart - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=shopping_cart">
...
<div class="heading"><h1>Contenu de votre panier</h1></div>
...
<form role="form" name="cart_quantity" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=shopping_cart&amp;action=update_product" method="post"><input type="hidden" name="securityToken" value="a9c803e7acb2e2a793f102deb2851196" /><div id="cartInstructionsDisplay" class="content">Vous trouverez ici les éléments que vous avez ajouté à vtre panier</div>

  <div class="cartTotalsDisplay important">Total Items: 2&nbsp;&nbsp;Weight: 9lbs&nbsp;&nbsp;Amount: 102.00 DT</div>
  <br class="clearBoth" />
...
<table class="table table-bordered" border="0" width="100%" cellspacing="0" cellpadding="0" id="cartContentsDisplay">
     <tr class="tableHeading">
        ...
        <th scope="col" id="scProductsHeading">Nom produit</th>
        <th scope="col" id="scUnitHeading">Prix</th>
        <th scope="col" id="scQuantityHeading">Quantité</th>
        <th scope="col" id="scTotalHeading">Total</th>
        <th scope="col" id="scRemoveHeading">Supprimer</th>
        <th scope="col" id="scUpdateQuantity">Rafraichir</th>
     </tr>
         <!-- Loop through all products /-->
     <tr class="rowEven">
        <td class="cartProductDisplay">
            <a href=>
                <span id="cartImage"><img src="images/06.png" class="img-responsive" alt="Plumb Pak 12-in Brass Push Fit In-Line Straight Valve" title=" Valve de contrôle en plomb push in " width="150" height="150" /></span>
            </a>
        </td>
       
       <td class="cartProductDisplay">
<a ><span id="cartProdTitle" class="heading">Valve de contrôle en plomb push in<span class="alert bold"></span></span></a>
<br class="clearBoth" />


       </td>
       <td class="cartUnitDisplay price" data-title="Unit price">12.00 DT</td>
       
       
       <td class="cartQuantity">
        <input type="text" name="cart_quantity[]" value="1" size="4" /><span class="alert bold"></span>       </td>
       
       
       <td class="cartTotalDisplay" data-title="Total">12.00 DT</td>
       <td class="cartRemoveItemDisplay">
       
<input type="checkbox" name="cart_delete[]" value="6" /></td>

        <td class="cartQuantityUpdate buttonRow">
        <input type="image" src="includes/templates/template_default/buttons/english/button_update_cart.png" alt="changer la quantité en cliquant sur lechamp associé, puis cliquer sur ce bouton" title=" changer la quantité en cliquant sur lechamp associé, puis cliquer sur ce bouton " /><input type="hidden" name="products_id[]" value="6" />       </td>

     </tr>
     <tr class="rowOdd">
        <td class="cartProductDisplay">
            <a >
                <span id="cartImage"><img src="images/12.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Lavabo en céramique Bronze style carthage " width="150" height="150" /></span>
            </a>
        </td>
       
       <td class="cartProductDisplay">
<a href="file:///C:/Users/Achraf/Desktop/Projet/produit2.html"><span id="cartProdTitle" class="heading">Lavabo en céramique Bronze style carthage<span class="alert bold"></span></span></a>
<br class="clearBoth" />


<input type="hidden" name="id[12:8731678392cb38b7f2e66b9fcebe5b49][2]" value="37" /><input type="hidden" name="id[12:8731678392cb38b7f2e66b9fcebe5b49][3]" value="9" /><div class="cartAttribsList"><ul>


</ul></div>       </td>
       <td class="cartUnitDisplay price" data-title="Unit price">90.00 DT</td>
       ...
       <td class="cartTotalDisplay" data-title="Total">90.00 DT</td>
       <td class="cartRemoveItemDisplay">
       
<input type="checkbox" name="cart_delete[]" value="12:8731678392cb38b7f2e66b9fcebe5b49" /></td>

        <td class="cartQuantityUpdate buttonRow">
        <input type="image" src="includes/templates/template_default/buttons/english/button_update_cart.png" alt="changer la quantité en cliquant sur lechamp associé, puis cliquer sur ce bouton" title=" changer la quantité en cliquant sur lechamp associé, puis cliquer sur ce bouton " /><input type="hidden" name="products_id[]" value="12:8731678392cb38b7f2e66b9fcebe5b49" />       </td>
...
<div id="cartSubTotal"><b>Total:</b>&nbsp;&nbsp;<span class="price">102.00 DT</span></div>
<div class="btn_trash"><input type="image" src="includes/templates/template_default/buttons/english/small_delete.png" alt="changer la quantité en cliquant sur lechamp associé, puis cliquer sur ce bouton" title=" changer la quantité en cliquant sur lechamp associé, puis cliquer sur ce bouton " /></div>
<br class="clearBoth" />
...
<div class="wrapper">
  ...
  <div class="btn cont_shop"><a href="http://localhost/views/mainpage1.php"><span class="cssButton normal_button button  button_continue_shopping" onmouseover="this.className='cssButtonHover normal_button button  button_continue_shopping button_continue_shoppingHover'" onmouseout="this.className='cssButton normal_button button  button_continue_shopping'">&nbsp;Continuer vos courses&nbsp;</span></a></div>
	  <a class="btn" ><span class="cssButton normal_button button  button_checkout" onmouseover="this.className='cssButtonHover normal_button button  button_checkout button_checkoutHover'" onmouseout="this.className='cssButton normal_button button  button_checkout'">&nbsp;Vérifier votre panier&nbsp;</span></a>	
	   	
	   <a class="btn" ><span class="cssButton normal_button button  button_shipping_estimator" onmouseover="this.className='cssButtonHover normal_button button  button_shipping_estimator button_shipping_estimatorHover'" onmouseout="this.className='cssButton normal_button button  button_shipping_estimator'">&nbsp;Comparateur de prix&nbsp;</span></a>	   
     	</div>
