            ...
            <div class="dropdown col-9">
                    ...
                    <ul id="fcarousel">
                                        ...
                                        <div class="product-col">
                                                <div class="img">
                                                    <a href="Services/clim.php"><img src="images/clim.jpg" class="img-responsive" title="répartion et entretien des chauffages et climatiseurs " width="200" height="200" /></a>
                                                </div>
...
<li ><a href="#" class="img-responsive" alt="Viessmann" title=" Viessmann " width="3390" height="1129" /></a></li>
    ...
    <!-- eof information -->
   	...
   	<li class="customer_service"><a class="drop">Service apres vente<span class="label"></span></a><!-- bof customer service -->
        
            <div class="dropdown col-5">
           
                <div class="col_cs">
                	<a href="http://localhost/STMP/views/reclammation.php">
                    <h3>reclamation</h3>
                    </a> 
                </div>
                ...
                <div class="col_cs">
                	<a href="http://localhost/STMP/views/requete.php">
                      <h3>request</h3>
                      </a> 
				</div>
...
<div class="slider-wrapper theme-default">
    	<div id="slider" class="nivoSlider">
			<a href="#"><img src="images/slide1.jpg" class="img-responsive" alt="" width="2050" height="568" /></a><a href="#"><img src="images/slide2.jpg" class="img-responsive" alt="" width="2050" height="568" /></a><a href="#"><img src="images/slide3.jpg" class="img-responsive" alt="" width="2050" height="568" /></a>			
        ...
        <div class="banners1">
          <div class="row">
          <div class="col-sm-4 col-xs-4 item item_1"><a href="#"><img src="images/item1.png" class="img-responsive" alt="New Products , sed do eiusmod tempor." title=" New Products , sed do eiusmod tempor. " width="370" height="217" /><div class="title"><div class="capt bounce-to-bottom"><h3><b>Nouveau</b> Produits</h3><p>Tous les nouveaux produits</p></div></div></a>
      </div>
      <div class="col-sm-4 col-xs-4 item item_2"><a href="#"><img src="images/item2.png" class="img-responsive" alt="Special Offer , sed do eiusmod tempor." title=" Special Offer , sed do eiusmod tempor. " width="370" height="217" /><div class="title"><div class="capt bounce-to-bottom"><h3><b>Offre</b> Special</h3><p>Nos offres specials</p></div></div></a>
      </div>
      <div class="col-sm-4 col-xs-4 item item_3"><a href="#"><img src="images/item3.png" class="img-responsive" alt="About Store , sed do eiusmod tempor." title=" About Store , sed do eiusmod tempor. " width="370" height="217" /><div class="title"><div class="capt bounce-to-bottom"><h3><b>Info</b> Boutique</h3><p>Plus d'informations</p></div></div></a>
		  </div>          </div>
        </div>
      </div>
          <div class="container">
...
<div class="centerBoxWrapper clearfix" id="featuredProducts">
    ...
    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" href="#">Sabela</a></h5>
				<div class="img">
					<a href="#"><img src="images/10.png" class="img-responsive" alt="Vigo One Handle Single Hole Pull Out Spray Kitchen Faucet" title=" Vigo One Handle Single Hole Pull Out Spray Kitchen Faucet " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">$20.00</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" href="#"><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au pannier&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="#"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>    
      ...
      <li class="centerBoxContentsFeatured centeredContent back  i2" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" href="#">Khyout naarech taa chnoa</a></h5>
				<div class="img">
					<a href="#"><img src="images/15.png" class="img-responsive" alt="Watts 1-in x 1-ft Reinforced PVC Reinforced Braided Vinyl Tubing" title=" Watts 1-in x 1-ft Reinforced PVC Reinforced Braided Vinyl Tubing " width="200" height="200" /></a>
					<div class="price">
				...
				<h5><a class="product-name name" href="#">Yosemite Home Decor One Handle Centerset Bathroom Faucet - Y</a></h5>
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=19"><img src="images/19.png" class="img-responsive" alt="Yosemite Home Decor One Handle Centerset Bathroom Faucet - YP42V" title=" Yosemite Home Decor One Handle Centerset Bathroom Faucet - YP42V " width="200" height="200" /></a>
					<div class="price">
				...
				<h5><a class="product-name name" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=18">Whitehaus Collection Forever Hot One Handle Single Hole Drin</a></h5>
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=18"><img src="images/18.png" class="img-responsive" alt="Whitehaus Collection Forever Hot One Handle Single Hole Drinking" title=" Whitehaus Collection Forever Hot One Handle Single Hole Drinking " width="200" height="200" /></a>
					<div class="price">
				...
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;action=buy_now&amp;products_id=18"><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Add to Cart&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=18"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>

    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=11">Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG</a></h5>
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=11"><img src="images/11.png" class="img-responsive" alt="Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300" title=" Vigo Single Hole Waterfall Bathroom Faucet Less Handles - VG0300 " width="200" height="200" /></a>
					<div class="price">
				...
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;action=buy_now&amp;products_id=11"><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Add to Cart&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=11"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
				...
				<h5><a class="product-name name" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=12">Vigo Tempered Glass Bathroom Sink - VG07505</a></h5>
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=12"><img src="images/12.png" class="img-responsive" alt="Vigo Tempered Glass Bathroom Sink - VG07505" title=" Vigo Tempered Glass Bathroom Sink - VG07505 " width="200" height="200" /></a>
					<div class="price">
				...
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;action=buy_now&amp;products_id=12"><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Add to Cart&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=12"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>    <li class="centerBoxContentsFeatured centeredContent back  i3" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=17">Whirlpool 6th Sense 50-Gallon 12-Year Tall Gas Water Heater </a></h5>
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=17"><img src="images/17.png" class="img-responsive" alt="Whirlpool 6th Sense 50-Gallon 12-Year Tall Gas Water Heater (Nat" title=" Whirlpool 6th Sense 50-Gallon 12-Year Tall Gas Water Heater (Nat " width="200" height="200" /></a>
					<div class="price">
				...
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;action=buy_now&amp;products_id=17"><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Add to Cart&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=5&amp;products_id=17"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>    <li class="centerBoxContentsFeatured centeredContent back  i4" style="width:25%;"><div class="product-col" data-match-height="featured">
				<h5><a class="product-name name" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=9">Undermount Kitchen Sink</a></h5>
				<div class="img">
					<a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=9"><img src="images/09.png" class="img-responsive" alt="Undermount Kitchen Sink" title=" Undermount Kitchen Sink " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">$359.00</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
					<div class="product-buttons">
						<div class="button"><a class="btn add-to-cart" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;action=buy_now&amp;products_id=9"><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Add to Cart&nbsp;</span></a></div>
						<div class="button1"><a class="btn products-button" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=product_info&amp;cPath=3&amp;products_id=9"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Details&nbsp;</span></a></div>
					</div>
				</div>
			</div></li>
...
<ul>
  ...
  <li><a href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=contact_us">Contacts</a></li>
