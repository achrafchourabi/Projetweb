...
<head>
<title>Tous les produits Page 1</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store New Products">
<meta name="description" content="Zen Cart! : New Products - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=products_new">
...
<h2 class="centerBoxHeading">Tous les produits</h2>

<div class="top_sort">
<div class="content_sortPagiBar list">
    <div class="dropdown">
      <form name="sorter_form" id="sort_form" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=products_new" method="get">
          <input type="hidden" name="main_page" value="products_new" />          <input type="hidden" name="disp_order" value="1" id="disp_order"/>
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuSort">
                        <li ><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 1;document.getElementById('sort_form').submit();">Nom du produit</a></li>
            <li ><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 2;document.getElementById('sort_form').submit();">Nom du produit - desc</a></li>
            <li ><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 3;document.getElementById('sort_form').submit();">Prix - du plus bas au plus cher</a></li>
            <li ><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 4;document.getElementById('sort_form').submit();">Prix - du plus cher au plus bas</a></li>
            <li ><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 5;document.getElementById('sort_form').submit();">Modèle</a></li>
            <li selected="selected"><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 6;document.getElementById('sort_form').submit();">Date d'ajout - du nouveau au plus ancien</a></li>
            <li ><a role="menuitem" href="javascript:void(0);" onclick="document.getElementById('disp_order').value = 7;document.getElementById('sort_form').submit();">Date d'ajout - du plus ancien au nouveau</a></li>
          </ul>
      </form>
    </div>	
</div><div class="clearfix"></div>
<div class="top-pg">
<div id="newProductsDefaultListingTopNumber" class="navSplitPagesResult back">Affichage <strong>1</strong> à <strong>10</strong> (de <strong>16</strong> produits)</div>
<div class="top-paginator">
    <ul class="pagination">
         &nbsp;<strong class="current">1</strong>&nbsp;&nbsp;<a href="http://localhost/views/touslesP2.php" title=" Page 2 ">2</a>&nbsp;&nbsp;<a href="http://localhost/views/touslesP2.php" title=" Next Page ">[Suivante&nbsp;&gt;&gt;]</a>&nbsp;    </ul>
...
<ul class="product_list row list">
 <li class="col-xs-12">
	...
	<div class="product-container">
            <div class="row">
                                                <div class="img">
                                        <a ><img src="http://localhost/views/baignoire-mini.jpg" class="img-responsive" alt="Oatey 316-in x 5-ft Rubber Utility Hose" title=" Baignoire-mini forme ronde céramique " width="200" height="200" class="listingProductImage" /></a>                                </div>
                                                                <div class="center-block col-xs-4 col-xs-7 col-md-4">
                                    <h5 itemprop="name">
                        <a class="product-name name" >Baignoire-mini forme ronde céramique</a>
                    </h5>
                    <div class="text">
            <span class="list-desc"></span>
            <span class="grid-desc"></span>
                                                                ...
                                                                <div class="product-buttons">
                                    <div class="content_price col-xs-5 col-md-12">
                                        <span itemprop="price" class="price product-price"><span class="productSalePrice">230.00 DT</span></span><div class="clearfix"></div><div class="button"><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div><div class="button1"><a class="btn" ><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div><br />                                    </div>
                                </div>
                                            </div>
        </div>   
     <li class="col-xs-12">
	<div class="product-container">
            <div class="row">
                                                <div class="img">
                                        <a ><img src="http://localhost/views/baignoire1.jpg" class="img-responsive" alt="Plumb Craft 5 Position Hand Held Shower Head - 8661" title=" Baignoire encastrable forme carrée" width="200" height="200" class="listingProductImage" /></a>                                </div>
                                                                <div class="center-block col-xs-4 col-xs-7 col-md-4">
                                    <h5 itemprop="name">
                        <a class="product-name name" >Baignoire encastrable forme carrée </a>
                    </h5>
                    <div class="text">
            <span class="list-desc"></span>
            <span class="grid-desc"></span>
	...
	<div class="product-container">
            <div class="row">
                                                <div class="img">
                                        <a ><img src="http://localhost/views/baignoire-mini-NB.jpg" class="img-responsive" alt="Plumb Craft 6 Spray Setting Fixed Shower Head - 8674000" title=" Baignoire mini couleur noire et blanc " width="200" height="200" class="listingProductImage" /></a>                                </div>
                                                                <div class="center-block col-xs-4 col-xs-7 col-md-4">
                                    <h5 itemprop="name">
                        <a class="product-name name" >Baignoire mini couleur noire et blanc</a>
                    </h5>
                    <div class="text">
            <span class="list-desc"></span>
            <span class="grid-desc"></span>
	...
	<div class="product-container">
            ...
            <span class="grid-desc"></span>
                                                                ...
                                                                <div class="product-buttons">
                                    <div class="content_price col-xs-5 col-md-12">
                                        <span itemprop="price" class="price product-price">&nbsp;<span class="productSpecialPrice">71.00 DT</span><span class="normalprice">89 DT </span><span class="productPriceDiscount">-20%</span></span><div class="clearfix"></div><div class="button"><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div><div class="button1"><a class="btn" href="file:///C:/Users/Achraf/Desktop/Projet/produit1.html"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div><br />                                    </div>
                                </div>
                                            </div>
        </div> 
     <li class="col-xs-12">
	<div class="product-container">
            ...
            <span class="grid-desc"></span>
                                                                ...
                                                                <div class="product-buttons">
                                    <div class="content_price col-xs-5 col-md-12">
                                        <span itemprop="price" class="price product-price">&nbsp;<span class="productSpecialPrice">90 DT</span><span class="normalprice">124 DT </span><span class="productPriceDiscount">-15%</span></span><div class="clearfix"></div><div class="button"><a class="btn add-to-cart" ><span class="cssButton normal_button button  button_add_to_cart" onmouseover="this.className='cssButtonHover normal_button button  button_add_to_cart button_add_to_cartHover'" onmouseout="this.className='cssButton normal_button button  button_add_to_cart'">&nbsp;Ajouter au panier&nbsp;</span></a></div><div class="button1"><a class="btn" href="file:///C:/Users/Achraf/Desktop/Projet/produit2.html"><span class="cssButton normal_button button  button_goto_prod_details" onmouseover="this.className='cssButtonHover normal_button button  button_goto_prod_details button_goto_prod_detailsHover'" onmouseout="this.className='cssButton normal_button button  button_goto_prod_details'">&nbsp;Détails&nbsp;</span></a></div><br />                                    </div>
                                </div>
                                            </div>
        </div>  
    </li>
...
<div class="bottom-pg">
  <div id="newProductsDefaultListingBottomNumber" class="navSplitPagesResult back">Affichage <strong>1</strong> à <strong>10</strong> (de <strong>16</strong> produits)</div>
  <div class="bottom-paginator">
    <ul class="pagination"> &nbsp;<strong class="current">1</strong>&nbsp;&nbsp;<a href="http://localhost/views/touslesP2.php" title=" Page 2 ">2</a>&nbsp;&nbsp;<a href="http://localhost/views/touslesP2.php" title=" Next Page ">[Suivante&nbsp;&gt;&gt;]</a>&nbsp;</ul>
  </div>
  </div>
