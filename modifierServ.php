...
<body>
  ...
  if (isset($_GET['ID'])){
  $climC=new servCore();
    $climM=$climC->recupererServ($_GET['ID']);
...
<th nom="ID" class="hidden-phone">ID</th>
                  ...
                  <th name="details" class="hidden-phone">details</th>
                  
<tr>
<td readonly="" class="hidden-phone"><input type="number" name="ID" value="<?PHP echo $ID ?>"></td>
                    ...
                    <td class="center hidden-phone"><input type="text" name="secteur" value="<?PHP echo $secteur?>"></td>
                     ...
                     <td readonly="" class="center hidden-phone"><input type="hidden" name="type" value="<?PHP echo $type?>"></td>
...
<td></td>
<td><input type="submit" name="modifier" value="modifier" action="back_clim.php"></td>
</tr>
<tr>
...
if (isset($_POST['modifier'])){
  $clima=new Services($_POST['ID'],$_POST['demande'],$_POST['lieu'],$_POST['secteur'],$_POST['details'],$_POST['nom'],$_POST['type']);
 $clim->modifierServ($clima,$_POST['ID']);
  echo $_POST['ID'];
