...
<head>
<title>Cuisine STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Kitchen">
<meta name="description" content="Zen Cart! : Kitchen - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=index&amp;cPath=3">
...
ou par fax au 01 46 49 10 81 </p>             
 ...
 <span> Cuisine</span>
   ...
   <h2 class="centerBoxHeading">Cuisine</h2> 
<div class="content_scene_cat_bg">

      		    <div id="category-image" class="categoryImg">
              <img src="http://localhost/views/cuisine.jpg" class="img-responsive" alt="" width="1040" height="400" />              <div class="cat_desc">
					                        <div class="catDescContent">
                            Catégorie Cuisine: Vous trouverez ici tous les accessoires ainsi que les éléments de cette catégorie                         </div>
...
<h2 class="centerBoxHeading">Nouveaux produits ( Mars ) - Cuisine</h2><ul class="prod-list1 clearfix w25">

           <li class="centerBoxContentsFeatured centeredContent back  i3" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Chauffe bain Whirlpool 6th Sense </a></h5>
				<div class="img">
					<a ><img src="images/17.png" class="img-responsive" alt="Whirlpool 6th Sense 50-Gallon 12-Year Tall Gas Water Heater (Nat" title=" Chauffe bain Whirlpool 6th Sense " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">650.00 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
				...
				<h5><a class="product-name name" >Robinet de collection whitehaus</a></h5>
				<div class="img">
					<a ><img src="images/18.png" class="img-responsive" alt="Whitehaus Collection Forever Hot One Handle Single Hole Drinking" title=" Robinet de collection whitehaus" width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">180.00 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
    ...
    <li class="centerBoxContentsFeatured centeredContent back  i1" style="width:25%;"><div class="product-col" data-match-height="new_prod">
				<h5><a class="product-name name" >Echangeur Chaud/Froid cuisine</a></h5>
				<div class="img">
					<a ><img src="images/19.png"  class="img-responsive" alt="Yosemite Home Decor One Handle Centerset Bathroom Faucet - YP42V" title=" Echangeur Chaud/Froid cuisine " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">43.50 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
				...
				<h5><a class="product-name name" >Echangeur Chaud/Froid style moderne </a></h5>
				<div class="img">
					<a href=><img src="images/20.png" class="img-responsive" alt="Yosemite Home Decor Roman Waterfall Tub Faucet" title=" Echangeur Chaud/Froid style moderne " width="200" height="200" /></a>
					<div class="price">
						<strong><span class="productSalePrice">65.00 DT</span></strong>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="prod-info">
