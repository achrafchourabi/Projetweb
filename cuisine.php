...
$listeproduits=$produit1C->affichercuisine();
...
foreach($listeproduits as $row){
  ?>
     <li class="centerBoxContentsFeatured centeredContent back  i3" style="width:25%;"><div class="product-col" data-match-height="new_prod">
        <h5><a class="product-name name" ><?PHP echo $row['nom']; ?> </a></h5>
        <div class="img">
          <a ><img src="<?php echo $row['photo']; ?>" class="img-responsive" alt="Whirlpool 6th Sense 50-Gallon 12-Year Tall Gas Water Heater (Nat" title=" Chauffe bain Whirlpool 6th Sense " width="200" height="200" /></a>
          <div class="price">
            <strong><span class="productSalePrice"><?PHP echo $row['prix']; ?> DT</span></strong>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="prod-info">
