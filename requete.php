...
<li ><a href="#" class="img-responsive" alt="Viessmann" title=" Viessmann " width="3390" height="1129" /></a></li>
	...
	<!-- mens -->
<form name="for" method="POST" action="ajouter_req.php" onsubmit="return validation();">
	
	<div align="center">
		<fieldset >
			<button class="btn btn-danger"><a style="color: #fff" href="affichh.php">Suivre vos requetes</a></button></br></br></br></br>
	<h3 align="center" style="color:#8e172c" > <b>VEUILLEZ TAPER VOTRE REQUETE D'ASSISTANCE </h3> </br> </br>
	
	 
			<tr>
				<td> <h4 align="center" style ="color:#8e172c"><b>Identifiant Client </b></h4></td>
				<td><input class="controle" type="text" name="IdProduit" placeholder="identifiant Client">
					<span class="resultat"></span>
 
			</tr></br></br>
			<tr>
				<td> <h4 align="center" style ="color:#8e172c"> <b>Identifiant Service :</b></br></h4></td>
				<td><input class="controle" type="text"  name="IdService"    placeholder="Identifiant Service"></td></br></br>
				<span class="resultat"></span>
				</td>
			</tr>
			<tr>
				<td><h4 align="center" style ="color:#8e172c"> <b>Email :</b></br></h4></td>
				<td><input type="text"   style="border-color: #8e172c" name="Email" ></td></br></br>
			</tr></br>
			
			<tr>
				<td> <h4 align="center" style ="color:#8e172c"><b> Type de demande :</b></br></h4></td>
				<td><input type="radio"  value="nouveau service" style="border-color: #8e172c" name="typeC">nouveau service</br>
					<input type="radio"  value="" style="border-color: #8e172c" name="typeC"></br>
					<input type="radio"  value="" style="border-color: #8e172c" name="typeC"></br></br>
				</td>
			</tr>
			<tr>
				<td><h4 align="center" style ="color:#8e172c"><b>Description </b></br></h4></td>
				<td><input type="text"  style="border-color: #8e172c" name="Objet"></td></br></br>
			<tr>
			<tr></br>
			...
			<tr>
				...
				<td><input style="color: #fff" class="btn btn-danger" type="submit" name="ajouter" value="VALIDER"></td>
