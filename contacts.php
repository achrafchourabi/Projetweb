...
<head>
<title>Contactez-nous STMG</title>
<meta charset="utf-8">
<meta name="keywords" content="Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store Contact Us">
<meta name="description" content="Zen Cart! : Contact Us - Bathroom Home & Garden Kitchen Repair Parts Tools Water Heaters Supplies Sinks Water Taps Accessories ecommerce, open source, shop, online shopping, store">
...
<link rel="canonical" href="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=contact_us">
...
<form role="form" name="contact_us" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=contact_us&amp;action=send" method="post"><input type="hidden" name="securityToken" value="3533a7ab9dffbbedcc8f0124fb5ee6ae" />
<h2 class="centerBoxHeading"> Contactez-nous</h2>
...
<form role="form" name="contact_us" action="http://livedemo00.template-help.com/zencart_55417/index.php?main_page=contact_us&amp;action=send" method="post"><input type="hidden" name="securityToken" value="3533a7ab9dffbbedcc8f0124fb5ee6ae" />
<address>3 rue de la Galité ,<br/><br />
Ben arous, Tunisie</address>


<div id="contactUsNoticeContent" class="content">
<p><strong>Vous pouvez nou contactez via un message directement sur le site</strong></p>
<p>Cette section est reservée aux clients pour toute information concernant le site , la société ou les produits que nous vendons</p>
<p>vous devez vous connectez pour nous envoyer un message</p></div>
    ...
    <div class="contact_fields_wrapper clearfix">
        ...
        <div class="contacts_left_fields col-xs-12 col-sm-5">
            <div class="form-group contact-group">
                ...
                <input type="text" name="contactname"  size="40" id="contactname" class="form-control" />            </div>
            <div class="form-group contact-group">
                <label for="email-address">Adresse Mail : </label>
                <input type="text" name="email"  size="40" id="email-address" class="form-control" />            </div>
        </div>
        
        <div class="form-group contact-group-area col-xs-12 col-sm-7">
            <label for="enquiry">Message:</label>
            <textarea name="enquiry" cols="20" rows="7" id="enquiry" class="form-control"></textarea>        </div>
    </div>
    </div>
    <br>
    <div>
        <input type="submit" class="btn btn-success add-to-cart" value="Envoyer" />        <a href="http://localhost/views/mainpage1.php"><span class="cssButton normal_button button  button_back" onmouseover="this.className='cssButtonHover normal_button button  button_back button_backHover'" onmouseout="this.className='cssButton normal_button button  button_back'">&nbsp;Retour&nbsp;</span></a>    </div>
</div>
<div class="clear"></div>
</div>
</div>
